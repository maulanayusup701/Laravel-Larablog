                ...
                <form action="/register" method="post">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control rounded-top @error('name') is-invalid @enderror "
                            name="name" id="name" value="{{ old('name') }}" placeholder="Name"required autofocus>
                    ...
                    <button class="w-100 btn btn-lg btn-primary fw-bold mt-3" type="submit">Register</button>
                </form>
